...
const guestMenu = [
    ...
    { id: 7, to: import.meta.env.VITE_AI_URL, name: "Trợ lý A*Care", hasArrow: false, isExternal: true, badge: "New" },
];
...
const adminMenu = [
    ...
    { id: 5, to: import.meta.env.VITE_AI_URL, name: "Trợ lý A*Care", hasArrow: false, isExternal: true, badge: "New" },
];
...
const doctorMenu = [
    ...
    { id: 4, to: import.meta.env.VITE_AI_URL, name: "Trợ lý A*Care", hasArrow: false, isExternal: true, badge: "New" },
];
